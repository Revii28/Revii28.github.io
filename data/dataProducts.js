const products = [
  ...
  [
    ...
    imgSrc: [
  '/public/images/1725895393414.jpg',
  '/public/images/1725895393415.jpg',
  '/public/images/1725895393417.jpg'
],
  ...
  [
    ...
    imgSrc: [
  '/public/images/1725896087697.jpg',
  '/public/images/1725896087698.jpg',
  '/public/images/1725896087700.jpg'
],
  ...
  { 
    id: 4,
    name: 'Jaket Dillan Sobek Ukuran L XL',
    price: [
  [
    179000
  ],
  [
    ...
    imgSrc: [
  '/public/images/1725896297497.jpg',
  '/public/images/1725896297499.jpg',
  '/public/images/1725896297501.jpg',
  '/public/images/1725896297503.jpg',
  '/public/images/1725896297505.jpg'
],
    description: 'Bahan : Jeans\r\n\r\n      L = Lebar 48cm X Panjang 62cm X Panjang Tangan 58cm\r\n      \r\n      XL = Lebar 53cm X Panjang 66cm X Panjang Tangan 61cm\r\n      \r\n      Berat Produk : 900gr\r\n      \r\n      SETIAP MINGGU TIDAK ADA PENGIRIMAN (LIBUR)\r\n      \r\n      (Barang Tidak Sesuai Pict / Gambar Boleh Tuker Kembali,', // Use JSON.stringify for description
    rating: '4.9 (854 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'L',
  'XL'
  ...
  { 
    id: 19,
    name: 'Elfora Maker Peel Off Atasi Masalah Flek Hitam',
    price: [
  [
    149000
  ]
    ...
    imgSrc: [
  '/public/images/1726164601497.jpg'
],
    description: 'Elfora Masker Peel Off Diformulasikan dengan Salmon DNA, Aloevera & Daisy Flower Yang ampuh mengangkat kotoran, mencerahkan dan memudarkan tanda tanda penuaan.\r\n\r\nManfaat Elfora :\r\n\r\n-Menyamarkan garis halus Tanda-tanda penuaan\r\n\r\n-Membantu mencerahkan\r\n\r\n-Menghaluskan Kulit Dan Mengangkat Komedo\r\n\r\n-Mengangkat Sel-sel Kulit Mati Di wajah\r\n\r\n-Meningkatkan elastisitas kulit\r\n\r\n-Menghilangka Flek Hitam\r\n\r\n-Teruji Aman Sudah BPOM NA 18230200801\r\n\r\nKOMPOSISI ELFORA Aqua,Ethanol,Polyvinyl Alcohol, Glycerin,Pvp, Bellis Perennis Flower Extract, Panthenol,Aloe Barbadensis Leaf Extract, Phenoxyethanol, Propanediol, Xanthan Gum,Fragrance (Parfum) Components and Finished Fragrances, Disodium Edta,Allantoin,Butylene Glycol,1,2-Hexanediol, Caprylyl Glycol, Sodium Dna, Acetyl Hexapeptide-8,\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.', // Use JSON.stringify for description
    rating: '4.8 (1.607 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Putih'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/elfora-maker-peel-off-atasi-masalah-flek-hitam'
  },
  { 
    id: 20,
    name: 'ZASMEN Lip Serum Khusus Pria BPOM',
    price: [
  [
    96440
  ]
    ...
    imgSrc: [
  '/public/images/1726164960274.jpg',
  '/public/images/1726164960271.jpg',
  '/public/images/1726164960277.jpg',
  '/public/images/1726164960280.jpg',
  '/public/images/1726164960282.jpg'
],
    description: 'MANFAAT :\r\n\r\n1. 100% Legal terdaftar BPOM\r\n\r\n2. Mengembalikan warna merah sehat bibir\r\n\r\n3. Melembabkan bibir dan mengatasi bibir kering dan pecah-pecah\r\n\r\n4. Mengunci kelembaban alami bibir\r\n\r\n5. Mengatasi bibir gelap karena rokok dan kopi\r\n\r\n6. Warna yang dihasilkan lebih natural layaknya warna bibir asli\r\n\r\n7. Meningkatkan elastisitas kulit bibir\r\n\r\nKOMPOSISI :\r\n\r\nTriethylhexanoin, Diisostearyl Malate, Phenyl Trimethicone,Dextrin palmitate, Silica Dimethyl Silylate, Hydrogenated Polyisobutene,polyglyceryl-2 isostearate, Cyclopentasiloxane, Phenoxyethanol, Simmondsia Chinensis (Jojoba) Seed Oil, Coconut (Cocos Nucifera) Oil, Olive (Olea Europaea) Oil, Peppermint (Mentha Piperita) Oil,ci 45410,ci 77499,Fragrance (Parfum) Components and Finished Fragrances,\r\n\r\nCARA PEMAKAIAN : Oleskan tipis pada bibir secara merata, lalu pijat lembut dengan jari. Gunakan setiap hari agar hasil lebih maksimal Warna akan terlihat tajam saat awal pemakaian, namun setelah 10-15 menit pengolesan, warna dan serum akan terserap!', // Use JSON.stringify for description
    rating: '4.8 (4.832 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Hitam'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/zasmen-lip-serum-khusus-pria-bpom'
  },
  { 
    id: 21,
    name: 'Bulu Mata Palsu Tempel Eyelash Extension Lentik Tebal Alami Tanpa Lem Berperekat Korean Look Soft',
    price: [
  [
    69000
  ]
    ...
    imgSrc: [
  '/public/images/1726165460986.jpg',
  '/public/images/1726165460989.jpg',
  '/public/images/1726165460990.jpg',
  '/public/images/1726165460996.jpg',
  '/public/images/1726165460997.jpg',
  '/public/images/1726165460999.jpg',
  '/public/images/1726165461000.jpg'
],
    description: 'Deskripsi : \r\n\r\nBahan : Serat Sintetis Alami\r\n\r\nUkuran : Sudah terdapat di tiap gambar variasi yaa\r\n\r\nJenis Bulu Mata Palsu : Strip Lashes\r\n\r\nJenis Bulu Mata Palsu : Bulu Mata Strip Penuh\r\n\r\nJenis Bulu Mata  : Panjang Alami\r\n\r\nTipe Barang : Ekstensi Bulu Mata\r\n\r\nPengemasan : 1 Pasang Bulu Mata \r\n\r\nCara penggunaan :\r\n\r\nStep 1  : memakai bulu mata setelah mencuci wajah, dari make up.\r\n\r\nStep 2  : lepaskan bulu mata dengan hati-hati dari kemasan. tarik perlahan bulu mata sampai terlepas dari kemasan\r\n\r\nStep 3  : bandingkan bulu mata palsu dengan panjang garis mata Anda, rapikan dengan panjang dan lebar yang sesuai\r\n\r\nStep 4  : tekan dengan lembut ke kelopak mata anda, dan selesai bulu mata telah terpasang dengan baik dan cantik.\r\n\r\nFitur :\r\n\r\n~ Tidak Perlu Lem atau Eyeliner - Bulu mata palsu terbaru yang mudah digunakan,\r\n\r\ntidak perlu lem atau eyeliner. Ini adalah perekat otomatis dan dapat diterapkan\r\n\r\ndalam 3 detik, sangat menyederhanakan proses riasan Anda.\r\n\r\nHemat waktu dan tenaga.\r\n\r\n~ Dapat digunakan kembali dan dicuci - Bulu mata palsu dapat digunakan kembali,\r\n\r\nlebih bersih dan sehat untuk digunakan. Muncul dengan strip perekat pengganti\r\n\r\nyang dapat diganti yang tidak akan jatuh bahkan setelah digunakan berulang kali.\r\n\r\n~ Bulu Mata Alami - Bulu mata palsu memiliki radian keriting yang indah dan\r\n\r\nmenyatu dengan bulu mata asli, membuat mata Anda lebih besar dan lebih menarik.\r\n\r\nAlami seperti bulu mata asli Anda tanpa memakai bulu mata palsu.\r\n\r\n~ Mudah Digunakan - Ringan dan lembut, sangat mudah digunakan berulang kali.\r\n\r\nPita tipis, bulu mata terlihat luar biasa dan cukup alami. Cocok untuk acara\r\n\r\npesta ulang tahun, dll. Anda dapat membawa bulu mata untuk pergi ke berbagai\r\n\r\ntempat.\r\n\r\n~ Kualitas tinggi - Terbuat dari serat sintetis premium, mudah digunakan dan\r\n\r\ndilepas, cocok untuk menciptakan tampilan siang atau malam. Tidak ada residu\r\n\r\nyang tertinggal di kulit, yang tidak menyebabkan alergi dan nyaman digunakan.\r\n\r\nReady stok selama katalog masih aktif :\r\n\r\n✅ HARGA BERSAING! \r\n\r\n✅ PRODUK BERKUALITAS \r\n\r\n✅ PROSES PENGGIRIMAN SUPER CEPAT! \r\n\r\n✅ PACKING AMAN DAN RAPI, FREE BUBBLE WRAP \r\n\r\n✅ PENGECEKAN PRODUK SEBELUM DIKIRIM \r\n\r\nCatatan : Tidak menerima perubahan pesanan melalui catatan dan chat. Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.\r\n\r\n🤗HAPPY SHOPPING🤗 🤝🤝WELCOME RESELLER DAN DROPSHIPPER🤝🤝', // Use JSON.stringify for description
    rating: '4.8 (8.163 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'DS001',
  'DS003',
  ...
  'DS064'
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/bulu-mata-palsu-tempel-eyelash-extension-lentik-tebal-alami-tanpa-lem-berperekat-korean-look-soft'
  },
  { 
    id: 22,
    name: 'Penjepit Bulu Mata Portable Electric Catokan eyelash Curler Big Eye Curling Long-lasting Hold',
    price: [
  [
    65000
  ]
    ...
    imgSrc: [
  '/public/images/1726165829063.jpg',
  '/public/images/1726165829065.jpg',
  '/public/images/1726165829065.jpg',
  '/public/images/1726165829069.jpg',
  '/public/images/1726165829072.jpg'
],
    description: 'Deskripsi : \r\n\r\nPenjepit bulu mata portable electric catokan eyelash curler big eye curling long-lasting hold tahan lama bisa dicharge praktis eyecurl melentikan bulu mata dengan mudah dan cepat\r\n\r\nKeuntungan : \r\n\r\n- Keriting yang lebih tahan lama dibandingkan penjepit bulu mata tradisional \r\n\r\n- Penjepit bulu mata, penjepit pemanas, 2 in 1\r\n\r\n- Dua tingkat kontrol suhu: dapat digunakan di bulu mata lembut dan keras \r\n\r\n- Pengisian USB: Pengisian cepat Type-C, masa pakai baterai tahan lama, jika terisi penuh, dapat digunakan selama 3 minggu. \r\n\r\n- Kecil dan ringan, cocok untuk semua jenis mata: maupun anda seorang pemula atau veteran, layak untuk mencoba, ringan dan portabel, mudah dibawa bepergian. \r\n\r\n- Desain ergonomis, lebih cocok untuk bentuk mata: desain bevel 15 °, mudah dipegang, tidak menghalangi garis pandang, aman dan anti panas, dan tidak melukai kulit. \r\n\r\nCara Penggunaan : \r\n\r\n1）Pemanasan awal: Tekan dan tahan sakelar selama 1,5 detik untuk memulai pemanasan awal, tunggu sekitar 30s , chuck silikon akan menjadi putih dan dapat digunakan. \r\n\r\n2) Sesuaikan penjepit bulu mata berpemanas listrik BOMIDI ke tingkat suhu yang sesuai - Lampu hijau: suhu rendah (≈65℃) - Cahaya biru: suhu sedang hingga tinggi (≈80℃) \r\n\r\n3) Gunakan penjepit bulu mata listrik BOMIDI untuk memanaskan dan memperbaiki kelengkungan bulu mata, durasi yang disarankan adalah 10-20 detik\r\n\r\n4) Harap dicatat bahwa penjepit bulu mata harus dijaga jarak tertentu dari kelopak mata untuk mencegah ketidaknyamanan. \r\n\r\n5) Menurut preferensi pribadi, Anda akhirnya dapat menambahkan maskara ke bulu mata\r\n\r\nInclude : \r\n\r\nPenjepit bulu mata berpemanas elektrik × 1 \r\n\r\nKabel pengisi daya USB × 1 \r\n\r\nPanduan produk × 1 \r\n\r\nKotak x1\r\n\r\nReady stok selama katalog masih aktif :\r\n\r\n✅ HARGA BERSAING! \r\n\r\n✅ PRODUK BERKUALITAS \r\n\r\n✅ PROSES PENGGIRIMAN SUPER CEPAT! \r\n\r\n✅ PACKING AMAN DAN RAPI, FREE BUBBLE WRAP \r\n\r\n✅ PENGECEKAN PRODUK SEBELUM DIKIRIM \r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih. \r\n\r\n🤗HAPPY SHOPPING🤗 🤝🤝WELCOME RESELLER DAN DROPSHIPPER🤝🤝', // Use JSON.stringify for description
    rating: '4.8 (6.721 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Putih'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/penjepit-bulu-mata-portable-electric-catokan-eyelash-curler-big-eye-curling-long-lasting-hold'
  },
  { 
    id: 23,
    name: 'Torrential Shampoo Anti Dandruff',
    price: [
  [
    120850
  ]
    ...
    imgSrc: [
  '/public/images/1726166103708.jpg',
  '/public/images/1726166103710.jpg',
  '/public/images/1726166103711.jpg',
  '/public/images/1726166103711.jpg'
],
    description: '⚠️SHAMPO BERGARANSI PERTAMA DI INDONESIA⚠️\r\n\r\nTORRENTIAL Daily Miraculous Shampoo merupakan Shampoo Anti-Ketombe yang dapat menghilangkan serta mencegah ketombe dan kulit kepala gatal.\r\n\r\nBERGARANSI 100% UANG KEMBALI\r\n\r\nAMPUH MENGATASI MASALAH KETOMBE:\r\n\r\n- Ketombe bersisik\r\n\r\n- Ketombe kering\r\n\r\n- Ketombe salju\r\n\r\n- Ketombe basah\r\n\r\nAROMA KESEGARAN BUAH PEAR TAHAN SAMPAI 24 JAM\r\n\r\nFITUR & BENEFIT\r\n\r\n1. Efektif mengatasi rambut berketombe.\r\n\r\n2. Membersihkan rambut dan kotoran minyak berlebih.\r\n\r\n3. Mencegah rambut kering bercabang\r\n\r\n4. Mengatasi kerontokan rambut\r\n\r\n5. Anti-lepek, melembutkan dan menambah kilau rambut\r\n\r\n6. Rambut harum tahan sampai 24 Jam\r\n\r\nKANDUNGAN UTAMA\r\n\r\nZinc PCA\r\n\r\nMenghilangkan ketombe yang terlihat maupun serpihan ketombe yang tidak terlihat, mengurangi rasa gatal dan menutrisi kulit kepala.\r\n\r\nSalicylic Acid\r\n\r\nAmpuh membersihkan dan menyingkirkan ketombe dan jamur pada kulit kepala\r\n\r\nCitric Acid\r\n\r\nTelah terbukti dapat membantu mengatasi ketombe kering, basah dan bersisik\r\n\r\nBPOM: NA18241000374\r\n\r\nRekomendasi Harga Jual : Beli 1 Rp. 125.000 | Beli 2 Rp. 185.000\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.', // Use JSON.stringify for description
    rating: '4.8 (5.931 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Biru'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/torrential-shampoo-anti-dandruff'
  },
  { 
    id: 24,
    name: '1 Set Kufi Kaligrafi Jumbo',
    price: [
  [
    129000
  ]
    ...
    imgSrc: [
  '/public/images/1726166397297.jpg',
  '/public/images/1726166397301.jpg',
  '/public/images/1726166397306.jpg',
  '/public/images/1726166397310.jpg'
],
    description: 'Set Kufi Kaligrafi Jumbo\r\n\r\nselain berfungsi sebagai penunjuk waktu, kaligrafi juga memiliki fungsi fungsi\r\n\r\nUntuk menambah keimanan\r\n\r\nMempermudah mengingat Allah agar hati menjadi tentram\r\n\r\nMendatangkan aura positif di dalam ruang\r\n\r\nMeningkatkan rasa syukur supaya ditambah rezekinya\r\n\r\nHarta yang dibelanjakan untuk ayat ayatnya pasti akan diganti dari arah yang tidak disangka-sangka\r\n\r\nAyat-ayat Allah terbukti dapat mendatangkan keberkahan.\r\n\r\nDeskripsi Produk:\r\n\r\n1 set terdiri dari 3 item\r\n\r\n1 pcs lafadz Allah\r\n\r\n1 pcs lafadz Muhammad\r\n\r\n1 pcs Ayat Kursi/Asmaul Husna/Dll\r\n\r\nSpec :\r\n\r\nBingkai full Kayu 12mm (tebal model pictbox bingkai)\r\n\r\nPhoto Papper Laminasi Glossy\r\n\r\nUkuran Tengah 40x60 cm, Allah Muhammad masing-masing 20x20 cm\r\n\r\nTanpa Kaca\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.\r\n\r\nHappy Shopping', // Use JSON.stringify for description
    rating: '4.8 (8.751 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Arrum',
  'Arra`du',
  ...
  'Asmaul husna'
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/1-set-kufi-kaligrafi-jumbo'
  },
  { 
    id: 25,
    name: '[ 4 Pcs ] Saringan Wastafel Penutup Lubang Saluran Air Kamar Mandi Saringan Filter Anti Bau',
    price: [
  [
    64000
  ]
    ...
    imgSrc: [
  '/public/images/1726166681174.jpg',
  '/public/images/1726166681180.jpg',
  '/public/images/1726166681181.jpg'
],
    description: 'Saringan Wastafel Penutup Lubang Saluran Air Kamar Mandi Saringan Filter Anti Bau 1 kg = 46 pcs Ukuran Estimasi : 45 mm x 38 mm x 30 mm Bahan : Elektroplating + Plastik PMMA + Silikon Asal : Import Tidak Ada Garansi Fitur : 1. Anti-blocking dan penghilang bau , anti air balik 2. Filter transparan dan terlihat, dapat dilepas dan dicuci kapan saja 3. Desain drainase perpindahan besar secara ketat mencegah pengembalian air/pengembalian bau 4. Filter anti penyumbatan Bahan tahan lama ABS, menyaring kotoran 5. Gasket Silikon Tingkatkan ukuran gasket anti bocor merah pengusir serangga.\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.', // Use JSON.stringify for description
    rating: '4.8 (4.788 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Merah'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/-4-pcs-saringan-wastafel-penutup-lubang-saluran-air-kamar-mandi-saringan-filter-anti-bau'
  },
  { 
    id: 26,
    name: 'Beewax Wood Seasoning Polish Pengkilap Furnitur Kayu',
    price: [
  [
    60500
  ]
    ...
    imgSrc: [
  '/public/images/1726166960554.jpg',
  '/public/images/1726166960556.jpg',
  '/public/images/1726166960557.jpg',
  '/public/images/1726166960558.jpg',
  '/public/images/1726166960559.jpg'
],
    description: 'Beewax Polish adalah bahan alami yang hebat untuk memoles, memperbaiki, dan mengembalikan keindahan alami kayu. Lilin lebah ini dapat menembus ke dalam kayu dan memberikan lapisan pelindung ke kayu. Ini dapat menghasilkan penampilan yang halus dan mengkilap.\r\n\r\nMemiliki furnitur kayu berlilin, bahan yang dapat menutupi celah dan mengurangi goresan pada permukaan. Dengan lapisan kedap air, tidak ada lagi cairan yang masuk ke dalam kayu yang menyebabkan kerusakan. Lilin lebah itu murni dan tidak beracun, yang 100% aman untuk anak-anak. Untuk menjaga rumah Anda tetap bagus & aman, PESAN SEKARANG!\r\n\r\nFITUR:\r\n\r\nPermukaan Kayu Halus: Lilin lebah dapat menjadikan permukaan kayu halus seperti sutra.\r\n\r\nKurangi Gores & Retak: Lilin lebah dapat membentuk lapisan yang padat dan mengkilap untuk menutupi semua goresan dan retakan kering yang mengembalikan keindahan alami kayu.\r\n\r\nTahan Air: Lilin bertindak sebagai lapisan tahan air untuk mencegah masuknya zat kelembaban ke dalam kayu.\r\n\r\nBahan Alami: Lilin lebah adalah bahan alami yang tidak beracun. Ini 100% aman untuk anak-anak.\r\n\r\nAplikasi Luas: Dapat diaplikasikan ke berbagai furnitur kayu seperti meja, kursi, lemari atau pintu', // Use JSON.stringify for description
    rating: '4.8 (6.870 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Hitam - Emas'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/beewax-wood-seasoning-polish-pengkilap-furnitur-kayu-1'
  },
  { 
    id: 27,
    name: 'Kunci Socket 46 in 1 Set Kunci Pertukangan Household & Auto Car Wrench Set',
    price: [
  [
    93200
  ]
    ...
    imgSrc: [
  '/public/images/1726167210073.jpg',
  '/public/images/1726167210075.jpg',
  '/public/images/1726167210076.jpg'
],
    description: 'Kunci Sok 46pcs Socket Tool adalah kunci set bongkar pasang yang dapat membantu anda untuk mengendurkan, hingga mengencangkan mur dan baut yang keras atau sulit diakses.\r\n\r\nSatu set kunci sok ini terdiri dari 46 macam kunci dengan bentuk dan ukuran berbeda. Terbuat dari material baja tensil serta dilapisi nikel berkualitas tinggi, kuat dan tidak mudah patah serta dilapisi dengan Chrome Vanadium Steel sehingga tahan terhadap karat yang muncul.\r\n\r\nCocok digunakan untuk mobil, motor, dan kegiatan perbengkelan kendaraan lainnya.\r\n\r\nMaterial : Chromium Vanadium Steel + Plastik\r\n\r\nUkuran Kotak : +/-23.5cm x 12.5cm x 4cm\r\n\r\nWarna Box / Kotak : Random (akan dikirim acak/sesuai dengan stok)\r\n\r\nDilengkapi :\r\n\r\n- 21 Pcs 1/4 Bit Socket : SL 4, 5.5, 7, PH1, 2, 3, PZ1, 2, 3, H3, 4, 5, 6, 7, 8, T10, 15, 20, 25, 30, 40\r\n\r\n- 3 Pcs Hex Socket - 13 Pcs 1/4 Dr.Socket : 4mm, 4.5mm, 5mm, 5.5mm, 6mm, 7mm, 8mm, 9mm, 10mm, 11mm, 12mm, 13mm, 14mm\r\n\r\n- 1 Pcs 1/4 Ratchet Handle\r\n\r\n- 1 Pcs 1/4 Universal Joint\r\n\r\n- 1 Pcs 1/4 Spinner Handle\r\n\r\n- 1 Pcs 1/4 Slide Bar\r\n\r\n- 1 Pcs 1/4 Extension Bar (50mm)\r\n\r\n- 1 Pcs Driver Adaptor\r\n\r\n- 1 Pcs 1/4 ExtenSion Bar (10mm)\r\n\r\n- 1 Pcs 1/4 Dr.Flexible Extension : 6Inch\r\n\r\n- Blow Case\r\n\r\nCara Penggunaan : Masukan mata kunci dengan gagang, Lalu putar kearah kiri untuk mengencangkan, dan kanan untuk mengendurkan.\r\n\r\nBerat Produk ±2.2Kg\r\n\r\nIsi Paket : 1 Set Kunci Sok 46pcs\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.', // Use JSON.stringify for description
    rating: '4.8 (7.664 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Hitam'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/kunci-socket-46-in-1-set-kunci-pertukangan-household-auto-car-wrench-set-1'
  },
  { 
    id: 28,
    name: '[ Varian Pcs ] Racun TIkus RATBUSTER 200gr Gratis Sarung Tangan Latex dan Wadah Umpan',
    price: [
  [
    77500
  ],
  [
    ...
    imgSrc: [
  '/public/images/1726167956290.jpg',
  '/public/images/1726167956298.jpg',
  '/public/images/1726167956307.jpg',
  '/public/images/1726167956315.jpg',
  '/public/images/1726167956324.jpg'
],
    description: 'BUNDLING 2 PCS 200GR RATBUSTER GRATIS SARUNG TANGAN + WADAH UMPAN\r\n\r\nRastsbuster adalah umpan beracun dibuat dengan formula khusus agar mudah dimakan tikus yang terdiri dari bahan-bahan yang disukai tikus.\r\n\r\nManfaat Ratsbuster\r\n\r\nKandungan Ratsbuster mampu membasmi tikus hingga mati kering dan tidak berbau\r\n\r\nMembunuh dalam 2-5 hari, hanya perlu 1 gigitan untuk bisa membunuh tikus\r\n\r\nMemiliki Bau umpan yang disenangi tikus tetapi tidak disenangi hewan peliharaan\r\n\r\nMempunyai bentuk kotak biru lilin, tidak larut dalam cairan sehingga tidak beresiko mencemari sumber air\r\n\r\nPetunjuk Penggunaan\r\n\r\nTaruh 3-5 kotak umpan dalam wadah dan letakkan di tempat tikus berkelaran. Tidak Perlu dicampur dengan bahan makanan.\r\n\r\nPetunjuk Keamanan\r\n\r\nHati-hati jangan sampai tertelan oleh manusia atau hewan peliharaan. Cucilah tangan sampai bersih dengan menggunakan air dan sabun apabila terkena kontak dengan umpan. Sebelum tidur, letakkan umpan di dapur, lantai, dsb, dan kumpulkan kembali sisa umpan pada hari berikutnya.', // Use JSON.stringify for description
    rating: '4.8 (7.267 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  '1 Pcs',
  '2 Pcs'
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/-varian-pcs-racun-tikus-ratbuster-200gr-gratis-sarung-tangan-latex-dan-wadah-umpan-1'
  },
  { 
    id: 29,
    name: 'SEMPROTAN AIR CUCI MOTOR HOSE NOZZLE SPRAY STEAM TAMAN MOBIL WATER JET',
    price: [
  [
    58500
  ]
    ...
    imgSrc: [
  '/public/images/1726168105691.jpg',
  '/public/images/1726168105692.jpg',
  '/public/images/1726168105694.jpg'
],
    description: 'Deskripsi  : \r\n\r\nMencuci mobil kadang melelahkan bagi Anda? Jangan khawatir! Kini ada semprotan air yang dapat menyemprot dengan kuat yang dapat dihubungkan keselang air, dengan menekan tuas maka air akan keluar dengan kencang. Spray Semprotan Air dengan nozzle adapter yang cocok dengan banyak jenis selang air, yang dapat dipasangkan dengan memutar ujung spray.\r\n\r\nBerat : 96 gram \r\n\r\nPipa air yang berlaku: diameter dalam 16mm, diameter luar 20mm\r\n\r\nFaucet yang berlaku : faucet berdiameter 14-20mm\r\n\r\nKeran Baskom diameter dalam 22mm，diameter luar 23mm\r\n\r\nBahan ujung: tembaga \r\n\r\nBAHAN  : TEMBAGA = ABS\r\n\r\nUKURAN : 2.6 X 17 CM\r\n\r\nNEPEL  : 1/2 INC SELANG ( STANDAR SELANG TAMAN DAN CUCI MOTOR )\r\n\r\nReady stok selama katalog masih aktif :\r\n\r\n✅ HARGA BERSAING! \r\n\r\n✅ PRODUK BERKUALITAS \r\n\r\n✅ PROSES PENGGIRIMAN SUPER CEPAT! \r\n\r\n✅ PACKING AMAN DAN RAPI, FREE BUBBLE WRAP \r\n\r\n✅ PENGECEKAN PRODUK SEBELUM DIKIRIM \r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.\r\n\r\n🤗HAPPY SHOPPING🤗', // Use JSON.stringify for description
    rating: '4.8 (6.199 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Hitam'
],
    ...
    stock: 199,
    linkPayment: 'https://rheastore.orderonline.id/semprotan-air-cuci-motor-hose-nozzle-spray-steam-taman-mobil-water-jet'
  },
  { 
    id: 30,
    name: 'Bor Portable Cordless JLD 12V 10mm Chuck Bor Besi Tembok Beton',
    price: [
  [
    215000
  ]
    ...
    imgSrc: [
  '/public/images/1726168312640.jpg',
  '/public/images/1726168312644.jpg',
  '/public/images/1726168312647.jpg',
  '/public/images/1726168312649.jpg',
  '/public/images/1726168312655.jpg'
],
    description: '🔧JLD Mesin bor Cordless Bisa bolak-balik\r\n\r\n12V - 2.0AH BATERAI\r\n\r\nKECEPATAN 0- 350-1750 RPM\r\n\r\nMax torque 35N.M VARIABLE SPEED\r\n\r\nDiameter Chuck Maks: 10mm\r\n\r\n🔧Bisa bor kayu beton besi tembok\r\n\r\nISI:\r\nJLD 1 baterai=2x mata+charger\r\n\r\nCatatan : Kami haya mengirim barang sesuai dengan yang dimasukan ke keranjang belanja. Jika ingin complain barang WAJIB ada video Unboxing. Membeli berarti menyetujui , Terima Kasih.', // Use JSON.stringify for description
    rating: '4.8 (6.393 Penilaian)',
    protection: 'Melindungi barang belanjaan dari kerusakan hingga 6 bulan',
    colors: [
  'Hitam - Merah'
],
